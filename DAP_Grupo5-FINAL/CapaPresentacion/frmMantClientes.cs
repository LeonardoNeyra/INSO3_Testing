...
namespace CapaPresentacion
{
    public partial class frmMantClientes : Form
    {
        ...
        {
            if(this.txtNombres.Text=="" || this.txtApellidos.Text== "" || this.txtDireccion.Text=="" || this.txtSaldoCuenta.Text== "" || this.txtRUC.TextLength!=11 || this.txtDNI.TextLength != 8)
            {
                MessageBox.Show("Campos Faltantes o Datos Erróneos", "Error al Guardar Cliente", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            if (existeC)
            {
                if (this.txtNombres.Text == "" || this.txtApellidos.Text == "" || this.txtDireccion.Text == "" || this.txtSaldoCuenta.Text == "" || this.txtRUC.TextLength != 11 || this.txtDNI.TextLength != 8)
                {
                    MessageBox.Show("Campos Faltantes o Datos Erróneos", "Error al Modificar Cliente", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
                    NCliente oCneg = new NCliente();
